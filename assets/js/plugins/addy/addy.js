(function() {
    ...
    ! function(t, e) {
        ...
        var n;
        return n = {}, n.VERSION = "1.5.10", n.addDomEvent = function(t, e, i) {
            var s;
            ...
            return n.classNameExists(t, e) || (e = " " + e, t.className += e), t
        }, n.removeClass = function(t, e) {
            var i, s, n, o, r;
            for (r = [], s = t.className.split(" "), n = 0, o = s.length; n < o; n++)(i = s[n]) !== e && r.push(i);
            ...
            if (s = 0, arguments.length > 0 && (s = Number(arguments[1]), s !== s ? s = 0 : 0 !== s && Infinity !== s && -Infinity !== s && (s = (s > 0 || -1) * Math.floor(Math.abs(s)))), s >= i) return -1;
            ...
            return i(s, t), s.prototype.defaults = {
                ...
                var s;
                return null == i && (i = {}), this.services.push(s = new n.Service(this, t, e, i)), s
            }, s.prototype.disable = function() {
                return this.enabled = !1, this.icon && n.addClass(this.icon, this.options.hidden_icon_class), this.output.innerHTML = "", this
            }, s.prototype.enable = function() {
                return this.enabled = !0, this.icon && n.removeClass(this.icon, this.options.hidden_icon_class), this
                ...
                var t, e, i, s;
                e = this.defaults, i = [];
                for (t in e) s = e[t], null == this.getOption(t) ? i.push(this.setOption(t, s)) : i.push(void 0);
                return i
            }, s.prototype._addListeners = function() {
                return n.addDomEvent(this.element, "focus", this._onFocus), n.addDomEvent(this.element, "keypress", this._onKeyPress), n.addDomEvent(this.element, "keydown", this._onKeyDown), n.addDomEvent(this.element, "blur", this._onBlur), n.addDomEvent(this.element, "paste", this._onPaste)
            }, s.prototype._removeListeners = function() {
                return n.removeDomEvent(this.element, "focus", this._onFocus), n.removeDomEvent(this.element, "keypress", this._onKeyPress), n.removeDomEvent(this.element, "keydown", this._onKeyDown), n.removeDomEvent(this.element, "blur", this._onBlur), n.removeDomEvent(this.element, "paste", this._onPaste)
            }, s.prototype._onFocus = function(t) {
                return this.focused = !0
            }, s.prototype._onKeyPress = function(t) {
                var e, i, s;
                if (i = t.which || t.keyCode, this.visible && 13 === i) return null != (s = this.highlighted) && s.selectItem(), e = this.getOption("ignore_returns"), e && t.preventDefault ? t.preventDefault() : e && (t.returnValue = !1), this.highlighted = null
                ...
                switch (t.which || t.keyCode) {
                    ...
                    case 40:
                        return this.visible && this._moveHighlight(1), !1;
                    case 9:
                        if (this.visible) return null != (e = this.highlighted) ? e.selectItem() : void 0;
                        break;
                    case 27:
                ...
                var e, i, s, n;
                return e = null != this.highlighted ? this.results.indexOf(this.highlighted) : -1, null != (s = this.highlighted) && s.unhighlight(), e += t, e < -1 ? e = this.results.length - 1 : e >= this.results.length && (e = -1), null != (n = this.results[e]) && n.highlight(), i = void 0 !== this._val ? this._val : "", this.element.value = null != this.highlighted ? this.highlighted.value : i
            }, s.prototype._getSuggestionsWithTimeout = function() {
                return null != this._timeout && clearTimeout(this._timeout), this._timeout = setTimeout(function(t) {
                    return function() {
                ...
                if (this.enabled) {
                    ...
                    if (this._val = this.element.value, this.error_content = null, "" !== this._val) {
                        for (i = this.services, s = [], t = 0, e = i.length; t < e; t++) n = i[t], s.push(n.search(this._val));
                        return s
                    }
                    return this._hideResults()
                }
                ...
                var t, e;
                return t = this.element, e = this._getVerticalOffset(), {
                    top: e + t.getBoundingClientRect().top + t.offsetHeight,
                    left: t.getBoundingClientRect().left
                }
            }, s.prototype._hideResults = function() {
                var t, e, i, s, n;
                for (this.visible = !1, this._applyStyle("display", "none"), this.results = [], i = this.services, s = [], t = 0, e = i.length; t < e; t++) n = i[t], s.push(n.results = []);
                return s
            }, s.prototype._displayResults = function() {
                var t;
                return this.visible = !0, t = this._getPosition(), this.options.container === document.body && (this._applyStyle("left", t.left + "px"), this._applyStyle("top", t.top + "px")), this._applyStyle("display", "block")
            }, s.prototype._renderItem = function(t, e) {
                var i;
                return i = document.createElement("li"), i.innerHTML = t, null != e && (i.className = e), n.addDomEvent(i, "mousedown", function(t) {
                    return function() {
                        return t.mouseDownOnSelect = !0
                    }
                }(this)), n.addDomEvent(i, "mouseup", function(t) {
                    return function() {
                ...
                var t, e, i, s, n;
                for (n = [], i = this.services, t = 0, e = i.length; t < e; t++) s = i[t], n.push(s.ready());
                return n.indexOf(!1) < 0
            }, s.prototype.showResults = function() {
                var t, e, i, s, n, o, r, h, u;
                if (this._servicesReady()) {
                    for (this.searchQueued && (this._getSuggestions(), this.searchQueued = !1), this.results = [], this.output.innerHTML = "", o = this.services, e = 0, s = o.length; e < s; e++) u = o[e], this.results = this.results.concat(u.results);
                    if (this.results.length) {
                        for (this.results = this.results.sort(function(t, e) {
                                return e.score - t.score
                            }), this.results = this.results.slice(0, +(this.getOption("max_results") - 1) + 1 || 9e9), r = this.results, i = 0, n = r.length; i < n; i++) h = r[i], this.output.appendChild(h.render());
                        null != this.options.footer_content && "" !== (t = this._renderFooter()) && this.output.appendChild(t), this._displayResults()
                ...
                var t, e, i, s, n;
                return n = this.element.offsetWidth, i = this.element.offsetHeight, s = this._getPosition(), e = i / 2, t = e / 2.4, {
                    coords: {
                        top: s.top - e - t,
                        left: s.left + n - e - t
                    },
                ...
                var i, s;
                return e = e || {}, i = e.class || "af_info_panel", !1 === e.persistant ? (this.output.innerHTML = "", s = this._renderItem(t, i), e.cancellable && this._addCancelButton(s, e), this.output.appendChild(s), this._displayResults()) : (this.infoPanel = {}, this.infoPanel.content = t, this.infoPanel.options = e)
            }, s.prototype._addCancelButton = function(t, e) {
                var i, s, o;
                return o = navigator.userAgent, i = o.indexOf("MSIE ") > -1 || o.indexOf("Trident/") > -1, s = document.createElement("span"), n.addClass(s, "cancel_button"), i && n.addClass(s, "IE"), s.addEventListener("click", function() {
                    return this.output.innerHTML = "", e.cancelHandler()
                }.bind(this)), t.appendChild(s)
            }, s
        }(n.Dispatch), n.Service = function(t) {
            function s(t, i, s, n) {
                this.widget = t, this.name = i, this.search_fn = s, this.options = null != n ? n : {}, this._response = e(this._response, this), this.ready = e(this.ready, this), this.results = [], this._ready = !0, this.response = function(t) {
                    return function(e, i) {
                        return t._response.apply(t, arguments)
                    }
                }(this)
            }
            return i(s, t), s.prototype.ready = function() {
                return this._ready
            }, s.prototype.search = function(t) {
                return this.last_query = t, this._ready = !1, this.search_fn(t, this.response)
            }, s.prototype._response = function(t, e) {
                var i, s, o;
                if (this.results = [], this.last_query === t) {
                    for (this.results = [], s = 0, o = e.length; s < o; s++) i = e[s], this.results.push(new n._Result(this, i));
                    return this._ready = !0, this.widget.showResults()
                }
            }, s
        }(n.Dispatch), n._Result = function() {
            function t(t, e) {
                var i, s, n, o;
                this.service = t, this.options = e, this.widget = this.service.widget, this.renderer = this.service.options.renderer || this.widget.options.renderer, this.value = null != (i = this.options) ? i.value : void 0, this.score = (null != (s = this.options) ? s.score : void 0) || 0, this.identifier = null != (n = this.options) ? n.identifier : void 0, this.data = (null != (o = this.options) ? o.data : void 0) || {}
            }
            return t.prototype.render = function() {
                ...
                }(this)), n.addDomEvent(this.li, "mouseover", function(t) {
                    return function() {
                        return t.highlight()
                    }
                }(this)), n.addDomEvent(this.li, "mouseout", function(t) {
                    return function() {
                        return t.unhighlight()
                    }
                }(this)), n.addDomEvent(this.li, "mousedown", function(t) {
                    return function() {
                        return t.widget.mouseDownOnSelect = !0
                    }
                }(this)), n.addDomEvent(this.li, "mouseup", function(t) {
                    return function() {
                ...
                var t;
                return null != (t = this.widget.highlighted) && t.unhighlight(), this.li.className = this.li.className + " " + this.widget.options.hover_class, this.widget.highlighted = this
...
}).call(this); /*!Reqwest! A general purpose XHR connection manager license MIT (c) Dustin Diaz 2015 https://github.com/ded/reqwest*/
! function(e, t, n) {
    ...
    var o = function() {
        for (var t = document.getElementsByTagName("script"), o = ["/" + (e = e.toLowerCase()) + ".js", "/addycomplete.js", "/addycomplete.min.js", e], i = 0; i < o.length; i++)
            for (var n = 0; n < t.length; n++)
                if (t[n].src && -1 !== t[n].src.toLowerCase().indexOf(o[i])) return t[n].src;
...
function AddyComplete(e, t) {
    if (e) {
        var o = this;
        o.urlBase = "https://api.addy.co.nz/", o.searchSuffix = "", o.requestSuffix = "", o.fields = t || {}, o.mode = "address", o.options = addySettingsFactory.createOptions(), o.key = addySettingsFactory.getKey();
        ...
        o.service = o.widget.addService("addy", function(e, t) {
            ...
            "address" === o.mode ? o.searchRequest("search", o.searchSuffix + "&s=" + e, function(o) {
                var i = new Array;
                if (o)
                    for (var n = 0; n < o.addresses.length; n++) i.push({
        ...
        }), o.service.timer = null, o.service.endSearch = function() {
            this.timer && clearTimeout(this.timer), this._ready = !0
        }, o.service.search = function(e) {
            if (!(e.length < 3)) return o.widget.error_content = null, this.last_query = e, this._ready = !1, this.timer = setTimeout(function() {
                this._ready = !0
            }, 3200), this.search_fn(e, this.response)
        }, o.setOption = function(e, t) {
            e && "exclude_postbox" === e ? o.options.excludePostBox = t : o.widget.setOption(e, t), r()
            ...
            o.mode = "postcode", o.setOption("empty_content", "Postcode not found. Please verify the spelling.")
        };
        NeatComplete.addDomEvent(e, "focus", function(t) {
            ...
            o.options.enableLocation = !1, o.setOption("empty_content", e), setTimeout(function() {
                o.setOption("empty_content", t)
            }, 2e3)
        }, o.handleLocationError = function(t) {
            o.makeRequest("errorlog", "&message=GeoFailCode:" + t.code + ":" + t.message, function(e) {}), o._onLocationResultsEmpty(o.getOption("location_unavailable")), o.service._response(o.service.last_query, []), e.placeholder = n
            ...
            o.makeRequest("geocode", "&x=" + t.coords.longitude + "&y=" + t.coords.latitude + "&limit=" + o.getMaxResults(), function(t) {
                var i = new Array;
                if (t)
                    for (var s = 0; s < t.addresses.length; s++) i.push({
                        value: t.addresses[s].displayname,
                        data: t.addresses[s]
                    });
                0 === i.length && o._onLocationResultsEmpty(o.getOption("location_not_found")), e.placeholder = n, o.service._response(o.service.last_query, i)
            }.bind(this))
        }, o.addressSelected = function(e) {}, o.postcodeSelected = function(e) {}, o.assignAddressFields = function(e) {
            ...
            o.makeRequest("address/" + e, "", function(e) {
                e && (o.assignAddressFields(e), o.assignRegion(e), o.addressSelected(e))
            }.bind(this))
        }, o.loadLocation = function() {
            e.value = "", e.placeholder = o.getOption("location_loading"), navigator.geolocation.getCurrentPosition(o.reverseGeocode, o.handleLocationError)
            ...
            return !(!o.key || "demo-api-key" !== o.key.toLowerCase()) && (o.setOption("footer_content", '<b>Demo Mode:</b> Create a free account at <a href="https://www.addy.co.nz/" class="link-active">addy.co.nz</a>'), !0)
        }, o.checkDemo(), r(), o.makeRequest("searchwarmup", "")
    } else console.warn("Input field is missing");

    function r() {
        o.searchSuffix = "&max=" + o.getMaxResults(), o.options.excludePostBox && (o.searchSuffix += "&expostbox=true"), o.options.exUndeliver && (o.searchSuffix += "&exundeliver=true"), o.options.exRural && (o.searchSuffix += "&exrural=true"), o.options.exSpelling && (o.searchSuffix += "&exspelling=true"), o.options.exWord && (o.searchSuffix += "&exword=true"), o.options.exIp && (o.searchSuffix += "&exip=true"), o.options.exPostcodes && "" !== o.options.exPostcodes && (o.searchSuffix += "&expostcode=" + o.options.exPostcodes), o.options.inPostcode && "" !== o.options.inPostcode && (o.searchSuffix += "&inpostcode=" + o.options.inPostcode), o.options.exRegion && "" !== o.options.exRegion && (o.searchSuffix += "&exregion=" + o.options.exRegion), o.options.inRegion && "" !== o.options.inRegion && (o.searchSuffix += "&inregion=" + o.options.inRegion), o.options.exTerritory && "" !== o.options.exTerritory && (o.searchSuffix += "&exterritory=" + o.options.exTerritory), o.options.inTerritory && "" !== o.options.inTerritory && (o.searchSuffix += "&interritory=" + o.options.inTerritory), o.requestSuffix = "", o.options.tag && "" !== o.options.tag && (o.requestSuffix += "&tag=" + o.options.tag), o.options.uniqueId && "" !== o.options.uniqueId && (o.requestSuffix += "&uniqueid=" + o.options.uniqueId)
    }
}
...
function callAddyInit() {
    var e = addySettingsFactory.createCallback(),
        t = !1;
    if (e ? (window[e](), t = !0) : "function" == typeof initAddy && (initAddy(), t = !0), t || initAddyByCss(), addySettingsFactory.getLoadCssEnabled()) {
        var o = document.createElement("link");
        o.setAttribute("rel", "stylesheet"), o.setAttribute("type", "text/css"), o.setAttribute("href", "https://www.addy.co.nz/css/addy.css"), document.getElementsByTagName("head")[0].appendChild(o)
    }
}
callAddyInit();