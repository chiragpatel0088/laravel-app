...
if (!isset($_GET['id']) && !isset($_GET['enc_id'])) {
    ...
    if (($isOperatorComplete == 1 && $session->userinfo['user_level'] == 1)) header("Location: operator_main");
    if (($job_status != 6 && $session->userinfo['user_level'] != 1)) header("Location: job?id=" . $job_id);
    //Not allow operator to access job status 2, 10, 11
    if ($session->userinfo['user_level'] == 1 && in_array($job_status, ['2', '10', '11'])) header("Location: operator_main");
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="flex-fill font-size-h2 text-white my-2">
                    <div class="d-flex align-content-center flex-wrap">
                        <span class="d-none d-lg-block"><i class="fa fa-toolbox text-white-50 mr-1"></i></span> <span>Operator Job Sheet</span>
                    </div>
                </h1>
...
<div class="content">
    <div class="block block-rounded block-bordered invisible" data-toggle="appear" data-timeout="200" id="form-section">
        <div class="block-content">
            <form action="process" method="POST" id="operator-job-form">
                <!-- Job details -->
                    ...
                    <div class="col-lg-12">
                        <div class="form-group form-row">
                            <div class="col-lg-6 col-6">
                                ...
                                <input type="text" class="js-datepicker form-control mb-2" id="job-date" name="job-date" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="<?php echo date("d/m/Y", strtotime($job_details['job_date'])); ?>">
                            ...
                            <div class="col-lg-6 col-6">
                                ...
                                <input type="time" required class="form-control bg-white" id="job-timing" name="job-timing" data-enable-time="true" data-no-calendar="true" data-date-format="H:i" data-time_24hr="false" value="<?php echo $job_details['job_timing'] ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php if ($job_details['isLinesmanJob'] == '1') : ?>
                ...
                <div class="row push mb-0">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="time" required class="form-control bg-white operator-job-field" id="actual-job-timing" name="actual-job-timing" data-enable-time="true" data-no-calendar="true" data-date-format="H:i" data-time_24hr="true" value="<?php echo $job_details['actual_job_timing'] ?>">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="first-concrete-mixer-arrival-time">First Mixer Arrival Time <span class="text-danger">*</span></label>
                            <input type="time" required class="form-control bg-white operator-job-field" id="first-concrete-mixer-arrival-time" name="first-concrete-mixer-arrival-time" data-enable-time="true" data-no-calendar="true" data-date-format="H:i" data-time_24hr="true" value="<?php if (!is_null($job_details['first_mixer_arrival_time'])) echo $job_details['first_mixer_arrival_time']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="time" required class="form-control bg-white operator-job-field" id="job-finish-time" name="job-finish-time" data-enable-time="true" data-no-calendar="true" data-date-format="H:i" data-time_24hr="true" value="<?php if (!is_null($job_details['job_time_finished'])) echo $job_details['job_time_finished']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
    ...
    <div class="block block-transparent" id="button-section">
        <div class="block-content">
            <div class="text-center">
                <?php if ($job_status == 6) { ?>
                    <button type="submit" id="operator-complete-job" name="suboperatorcompletejob" class="btn btn-hero-success mr-1 mb-3">
...
<?php $dm->get_js('js/pages/operator_job_page.js'); ?>
