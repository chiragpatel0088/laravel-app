...
class Template {
    ...
    public function get_css($asset_css) {
        echo "<link rel=\"stylesheet\" href=\"$this->assets_folder/$asset_css" . "?filever=" . filemtime($this->assets_folder . "/" . $asset_css) . "\">\n";
    }
    ...
    public function get_js($asset_js) {
        echo "<script src=\"$this->assets_folder/$asset_js" . "?filever=" . filemtime($this->assets_folder . "/" . $asset_js) . "\"></script>\n";
    }
