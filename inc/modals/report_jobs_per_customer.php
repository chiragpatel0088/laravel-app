...
<div class="modal fade" id="modal-customer-jobs-by-year" tabindex="-1" role="dialog" aria-labelledby="modal-customer-jobs-by-year" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">Choose Year for Customer Jobs Per Year Report</h3>
                ...
                <form action="jobs_per_customer_report_pdf" target="_blank" method="POST">
