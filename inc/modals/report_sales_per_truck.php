...
<div class="modal fade" id="modal-sales-per-truck-report" tabindex="-1" role="dialog" aria-labelledby="modal-sales-per-truck-report" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">Choose Year for Sales per Truck Report</h3>
                ...
                <form action="sales_per_truck_report_pdf" target="_blank" method="POST">
