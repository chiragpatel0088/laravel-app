...
<div class="modal fade" id="modal-job-report-by-year" tabindex="-1" role="dialog" aria-labelledby="modal-job-report-by-year" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">Choose Year for Job Report</h3>
                ...
                <form action="customer_jobs_report_by_year_pdf" target="_blank" method="POST">
