...
if (!isset($_POST['searchTerm'])) {
    $query = "SELECT * FROM " . TBL_USERS . "  WHERE user_level != '3' AND user_activated = '1' ORDER BY user_firstname";
} else {
    $searchTerm = $_POST['searchTerm'];
    $query = "SELECT * FROM " . TBL_USERS . " WHERE (user_firstname LIKE '%" . $searchTerm . "%' OR user_lastname LIKE '%" . $searchTerm . "%') AND user_level != '3' AND user_activated = '1'";
}
