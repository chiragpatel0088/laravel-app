...
// Setup session and database connection for website ( Causes undefined index bug in PHP log when user accesses a page which requires a logged in user)
...
$dm                             = new Template($config['SITE_NAME'], $config['Version'], 'assets');
...
$dm->author                     = $config['AUTHOR'];
$dm->robots                     = 'noindex, nofollow';
$dm->title                      = $config['SITE_NAME'];
$dm->description                = $config['SITE_DESC'];
